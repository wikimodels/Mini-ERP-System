...
export function createEchartOption(dayIncomes: EchartDayIncome[]) {
  return {
    tooltip: {
      trigger: 'axis',
      axisPointer: {
    ...
    xAxis: [createEchartXAxis(dayIncomes)],
    yAxis: [
      {
        type: 'value',
        name: 'операции',
    ...
    series: [
      createEchartLineSeries(dayIncomes),
      createEchartBarSeries(dayIncomes),
    ],
  };
}
